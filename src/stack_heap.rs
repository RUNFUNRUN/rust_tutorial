...
pub fn run() {
    ...
    println!("Len of s1 is: {}", v1.len());
    println!("Capacity of s1 is: {}", v1.capacity());
    v1.insert(1, 10);
    println!("{:?}", v1);
    v1.remove(0);
    println!("{:?}", v1);
    ...
    println!("Stack adress of tupple data is: {:p}", &t1);
    ...
    (*b1).1 += "world";
    println!("{} {}", b1.0, b1.1);
    println!("Stack adress of box pointer is: {:p}", &b1);
